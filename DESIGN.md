...
7. Leaflet and D3 loaded from CDN only — no npm, no bundler
8. Every interactive element must have a visible hover state
9. Chat panel is an overlay — never pushes layout
10. Mobile layout is out of scope — desktop only, min-width 1024px
