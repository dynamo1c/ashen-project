...
req.on('error', (err) => {
  if (err.code === 'ECONNREFUSED') {
    ...
    console.error("[-] To start the local server, open a separate terminal window and run:");
    console.error("    cd \"c:\\Users\\Yoooo!\\Documents\\datathon\"");
    console.error("    catalyst serve");
  } else {
