...
def main():
    print("==================================================")
    # File paths
    csv_path = 'fir_records_seed.csv'
    output_path = 'district_monthly_incidents.csv'
    
    if not os.path.exists(csv_path):
        print(f"[-] ERROR: Raw seed file '{csv_path}' not found in the workspace root.")
        sys.exit(1)
    ...
    # This format is highly compatible with QuickML's Time Series Date parsing (valid Date type)
