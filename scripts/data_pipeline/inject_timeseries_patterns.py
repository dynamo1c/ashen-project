...
def main():
    ...
    input_path = os.path.join(ROOT_DIR, 'data', 'seeds', 'district_monthly_incidents.csv')
    output_path = os.path.join(ROOT_DIR, 'data', 'seeds', 'district_monthly_incidents_v2.csv')
