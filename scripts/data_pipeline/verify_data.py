...
def main():
    ...
    # File paths
    fir_file = os.path.join(ROOT_DIR, 'data', 'seeds', 'fir_records_seed.csv')
    offender_file = os.path.join(ROOT_DIR, 'data', 'seeds', 'offenders_seed.csv')
    drs_file = os.path.join(ROOT_DIR, 'data', 'seeds', 'district_risk_scores_seed.csv')
